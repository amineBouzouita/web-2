...
<form action="" method="POST">
    ...
    <input type="submit" value="tri">
        ...
        <tr>
            ...
            <td>    <a href=<?PHP echo 'UserModifier.php?id='.$util['id'] ?> > Modifier </a></td>
            <td> <a href=<?PHP echo 'UserSupprimer.php?id='.$util['id'] ?> > Supprimer </a></td>
        </tr>
<?php } ;?>
        </table>
        <a href=<?PHP echo 'UserAjouter.php'?> > Ajouter User </a></td>
</body>
</html>
